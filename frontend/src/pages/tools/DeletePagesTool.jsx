...
export default function DeletePagesTool() {
    ...
    const handleSubmit = async () => {
        ...
        if (!pages) return alert("Enter pages to delete!");
        ...
        try {
            ...
            const res = await fetch(`${API_BASE}/api/delete-pages/`, {
                method: "POST",
                body: fd,
            });
            ...
            a.href = url;
            a.download = (outputName || file.name.replace(/\.pdf$/i, "") + "_deleted") + ".pdf";
            ...
            <div style={{ marginBottom: 16 }}>
                <input
                    ...
                    onChange={(e) => {
                        ...
                        setFile(f);
                        if (f) setOutputName(f.name.replace(/\.pdf$/i, "") + "_deleted");
                    }}
                />
            </div>
            <div style={{ marginBottom: 16 }}>
