    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(txt || "Flatten failed");
            }
            ...
            a.href = url;
            a.download = (outputName || "flattened_" + file.name) + (outputName ? ".pdf" : "");
    ...
    return (
        <div className="toolCard" style={{ marginTop: 24 }}>
            ...
            <p style={{ marginBottom: 20, color: "#666" }}>
                Flatten form fields and annotations into the page content, making them uneditable.
            </p>
            ...
            <div style={{ marginBottom: 16 }}>
                <input
                    ...
                    onChange={(e) => {
                        ...
                        setFile(f);
                        if (f) setOutputName("flattened_" + f.name.replace(/\.pdf$/i, ""));
                    }}
                />
            </div>
            ...
            >
                {loading ? "Processing..." : "Flatten PDF"}
            </button>
        </div>
    );
}
