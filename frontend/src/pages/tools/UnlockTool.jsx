...
export default function UnlockTool() {
    ...
    const handleSubmit = async () => {
        ...
        if (!password) return alert("Enter the password!");
        ...
        try {
            ...
            a.href = url;
            a.download = (outputName || "unlocked_" + file.name) + (outputName ? ".pdf" : "");
            ...
            console.error(e);
            alert("Failed to unlock PDF. Check password?");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div style={{ marginBottom: 16 }}>
                <input
                    ...
                    onChange={(e) => {
                        ...
                        setFile(f);
                        if (f) setOutputName("unlocked_" + f.name.replace(/\.pdf$/i, ""));
                    }}
                />
            </div>
            <div style={{ marginBottom: 16 }}>
