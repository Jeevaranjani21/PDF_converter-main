...
export default function WatermarkTool() {
    ...
    const onProcess = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${API_BASE}/api/watermark/`, formData, {
                responseType: "blob",
            });
            ...
            setErr(e.message || "Failed to add watermark");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="categoryPage">
            <h1 className="pageTitle">Watermark PDF</h1>
            <p className="pageSubtitle">Add text watermark to your PDF.</p>
            ...
            <div className="toolCard">
                <div style={{ width: "100%" }}>
                    <div style={{ fontWeight: 700, marginBottom: 10 }}>2) Watermark Options</div>
